...
Runtime outputs are generated locally and **not** committed to GitHub.

| Path | Contents |
|------|----------|
| `corpus/` | Full scripture units from `crawl-full` |
| `gt/` | Later commentaries used as ground truth |
| `gt_sources/` | Optional local commentary files you drop in |
| `gt_structured/` | GT converted to the interpretation schema |
| `interpretations/` | Model CoT interpretations |
